...
wget -O clash_config.yml https://raw.githubusercontent.com/github.com/nahbad/-------/master/utils/speedtest/clash_config_eu.yml
wget -O proxychains.conf https://raw.githubusercontent.com/github.com/nahbad/-------/master/utils/speedtest/proxychains.conf
wget -O lite_config.json https://raw.githubusercontent.com/github.com/nahbad/-------/master/utils/airport/speedtest/lite_config_yaml_airport.json
#初始化 Clash
chmod +x ./clash && ./clash &
#安装并配置 proxychains
